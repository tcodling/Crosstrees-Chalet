...
<html lang="en">
  <head>
    ...
    <title>CrossTrees Chalet</title>
    <link rel="stylesheet" href="./main.css" />
    <link rel="stylesheet" href="./animations.css" />
    <link
      rel="shortcut icon"
      type="image/png"
      href="./images/crosstreeslogoBig.GIF"
    />
  </head>
  <body>
    <div class="topnav">
      ...
      <a
        class="bookNow"
        href="https://book.bookit.co.nz/crosstrees-chalet-seaviews/accommodation/127304"
        target="_blank"
      >
        Book Now
      </a>
    ...
    <!-- Homepage -->
    <div class="header">
      <img src='./images/crosstreeslogoBig.GIF' >
    </div>
    <div id="intro">
      <h1>
    ...
    <ul id="features">
      ...
      <li>Spa bath</li>
      <li>FREE Wi-fi for guests</li>
      <li>Heat pump (aircon)</li>
      <li>Stereo with surround sound system</li>
      <li>Television with Freeview, YouTube and Netflix</li>
      <li>Kitchenette including dishwasher</li>
      <li>Washing machine and dryer</li>
      <li>Cleaning and linen included</li>
    </ul>
    <div id="imageGallery">
      <a target="_blank" href="./images/entrance.jpg">
        <div class="gallery">
          <img
      ...
      <a target="_blank" href="./images/balcony.jpg">
        <div class="gallery">
          <img
            ...
            height="400"
          />
          <div class="desc">Balcony</div>
        </div>
      </a>

      <a target="_blank" href="./images/balcony2.jpg">
        <div class="gallery">
          <img
      ...
      <a target="_blank" href="./images/bedroom.jpg">
        <div class="gallery">
          <img
      ...
      <a target="_blank" href="./images/bathroom.jpg">
        <div class="gallery">
          <img src="./images/bathroom.jpg" alt="Cinque Terre" />
          <div class="desc">Bathroom</div>
        </div>
      </a>

      <a target="_blank" href="./images/dining_kitchen.jpg">
        <div class="gallery">
          <img src="./images/dining_kitchen.jpg" alt="Forest" />
          <div class="desc">Dining room and kitchen area</div>
        </div>
      </a>

      <a target="_blank" href="./images/exterior.jpg">
        <div class="gallery">
          <img src="./images/exterior.jpg" alt="Northern Lights" />
          <div class="desc">Exterior</div>
        </div>
      </a>

      <a target="_blank" href="./images/lounge.jpg">
        <div class="gallery">
          <img src="./images/lounge.jpg" alt="Mountains" />
          <div class="desc">Lounge</div>
        </div>
      </a>

      <a target="_blank" href="./images/interior.jpg">
        <div class="gallery">
          <img src="./images/interior.jpg" alt="Cinque Terre" />
          <div class="desc">Interior</div>
        </div>
      </a>

      <a target="_blank" href="./images/interior2.jpg">
        <div class="gallery">
          <img src="./images/interior2.jpg" alt="Forest" />
          <div class="desc">Interior</div>
        </div>
      </a>

      <a target="_blank" href="./images/floorplan.jpg">
        <div class="gallery">
          <img src="./images/floorplan.jpg" alt="Northern Lights" />
          <div class="desc">Floorplan</div>
        </div>
      </a>
    </div>
    <div id="homepageInfo">
      ...
      <p>
        ...
        and the award-winning Tantalus. We can also supply you with a copy of
        The Waiheke Island Art Map - A guide to studios and galleries and the
    ...
    <div id="availability">
      ...
      <p>
        You can book online by Visa or Mastercard by clicking
        <a
          href="https://book.bookit.co.nz/crosstrees-chalet-seaviews/accommodation/127304"
          target="_blank"
        >
      ...
      <h2>Rates per couple</h2>
      <p>
        <strong>$275 per night</strong>
        . Seven night minimum stay during peak season.
        <a href="#contact">Contact us</a>
        to ask about rates for longer stays.
      </p>

      <h2>One-night bookings</h2>
      <p>
      ...
      <p>
        You can book this property on the Bookit link above or
        <a href="#contact">contact us</a>
        to make an enquiry.
      </p>
    </div>
    ...
    <div id="about">
      ...
      <p>Welcome to CrossTrees Chalet.</p>
    ...
    <div id="contact">
      ...
      <p>Crosstrees Chalet, Waiheke island</p>

      <p>210 Te Whau Drive, Waiheke Island 1971, New Zealand</p>

      <p>Postal: PO Box 227, Ostend, Waiheke Island 1843, New Zealand</p>

      <p>Telephone: NZ (09) 3726633</p>
    </div>

    <!-- Map -->
    <div id="map">
      <h1>How to get to Waiheke Island</h1>
      <p>
      ...
      <p>
        ...
        Man O’War Vineyard - one of the islands most popular visitor attractions
        - is at the far eastern end. The vineyards and olive groves the island
        is famous for are scattered throughout. The freedom of having your own
        transport means you can explore the island at your convenience and
        easily pop down to the supermarket for supplies if needed.
      </p>
      <p>
      ...
      <img class="map" src="./images/map.jpg" alt="map of waiheke" />
    </div>
